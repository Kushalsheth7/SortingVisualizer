...
class DrawInformation:
    ...
    def set_list(self, lst):
        ...
        if self.max_val == self.min_val:
            ...
            self.block_height = math.floor((self.height - self.TOP_PAD) / (100 - 0))
...
def draw(draw_info, algo_name, ascending):
    ...
    sorting = draw_info.FONT.render("I - Insertion Sort | B - Bubble Sort | S - Selction Sort | M - Merge Sort | H - Heap Sort", 1, draw_info.WHITE)
...
def heapify(lst, n, i, draw_info, ascending):
    ...
    if (left < n and lst[left] > lst[largest] and ascending) or (left < n and lst[left] < lst[largest] and not ascending):
        largest = left

    if (right < n and lst[right] > lst[largest] and ascending) or (right < n and lst[right] < lst[largest] and not ascending):
        largest = right
...
async def main():
    ...
    while run:
        ...
        # This is critical for pygbag to allow browser processing
